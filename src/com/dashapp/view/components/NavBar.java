...
public class NavBar extends HBox {
    ...
    private void createAuthenticatedNavButtons() {
        ...
        Button btnProjects = createNavButton("Projects", e -> ViewNavigator.navigateToProjects());
        ...
        this.getChildren().addAll(homeBtn, dashboardBtn, btnProjects, profileBtn, userLabel, logoutBtn);
    }
